...
contract BatteryInvestment {
    ...
    modifier isValidDividendTriggerModifier() {
        ...
        require(
            remainingInvestment >
                (investmentPercentage * totalInvestment) / 100,
        ...
        public
    {
        ...
        VirtualPowerPlantContract = VirtualPowerPlant(
            _virtualPowerPlantAddress
        );
        ...
        returns (bool)
    {
        ...
        uint256 totalCurrentDividend = (remainingInvestment *
        ...
        returns (uint256)
    {
        ...
        for (uint256 i = 0; i < investors[currentAddress].length; i++) {
            ...
            require(
                investors[currentAddress][i].investorAddress == currentAddress
            );
            // sum up all investments made by current investor
            totalCurrentInvestorAmt += investors[currentAddress][i]
                .investmentAmount;
        }
